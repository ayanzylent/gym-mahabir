...
const reviews = [
  ...
  },
  {
    ...
    initial: "E",
    date: "1 day ago",
    text: "The turf zone and Olympic lifting platforms are top tier. I've crushed all my plateaus since I switched to Gym Mahabir. Absolutely a 10/10 training facility.",
  },
  {
    name: "David K.",
    initial: "D",
...
export function Reviews() {
  return (
    <section id="reviews" className="bg-[#050505] w-full py-5 md:py-5 overflow-hidden relative border-t border-white/5">
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="text-center mb-10 md:mb-16">
          ...
          <div className="flex items-center justify-center gap-2 mb-6">
            <span className="text-white font-bold text-xl md:text-3xl">4.7</span>
            <div className="flex text-yellow-500">
              {[...Array(5)].map((_, i) => (
                <Star key={i} className="w-4 h-4 md:w-6 md:h-6 fill-current" />
              ))}
            </div>
            <span className="text-neutral-400 text-xs md:text-sm ml-2">Based on 30+ Google Reviews</span>
          </div>

          {/* Simple stats row */}
          <div className="flex flex-row justify-center gap-8 md:gap-16 pt-8 md:pt-10 mt-4 border-t border-white/10 max-w-2xl mx-auto">
            <div className="flex flex-col gap-1 items-center">
              <span className="text-2xl md:text-4xl xl:text-5xl font-black text-white">5+</span>
            ...
            <div className="flex flex-col gap-1 items-center">
              <span className="text-2xl md:text-4xl xl:text-5xl font-black text-white">300+</span>
