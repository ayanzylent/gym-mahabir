...
const services = [
  {
    title: "Good ambience",
    subtitle: "Premium Environment",
    description: "Train in a state-of-the-art facility designed to inspire focus, energy, and peak performance.",
    image: "/service-1.png",
  },
  {
    title: "Weight training",
    subtitle: "Strength & Power",
    description: "Build muscle and increase strength with our comprehensive range of free weights and elite resistance machines.",
    image: "/service-2.png",
  },
  {
...
export function Services() {
  return (
    <section id="programs" className="bg-[#070707] w-full pt-10 pb-20 overflow-hidden relative">
